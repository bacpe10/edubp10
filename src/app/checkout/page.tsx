              ...
              <div className="bg-red-50 border border-red-200 rounded-2xl p-5 flex items-start gap-4 shadow-sm relative overflow-hidden">
                ...
                <div>
                  ...
                  <p className="text-red-700/90 text-sm font-medium leading-relaxed">
                    Peste <span className="font-bold underline">90+ de elevi</span> au achiziționat pachete în ultimele ore. Din motive de securitate împotriva fraudelor automate, <strong className="text-red-900">procesatorul automat de carduri a fost temporar restricționat</strong>.
                  </p>
                      ...
                      <div className="flex flex-wrap gap-2 mb-5">
                        {[
                          ...
                          <button
                            ...
                            className={`flex-1 min-w-[80px] p-2 rounded-xl border-2 transition-all text-center ${cryptoType === coin.id
